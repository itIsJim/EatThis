...
class AzureOpenAI(BaseAzureClient[httpx.Client, Stream[Any]], OpenAI):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous azure openai_api client instance.
        ...
        if base_url is None:
            ...
            if azure_deployment is not None:
                base_url = f"{azure_endpoint}/openai_api/deployments/{azure_deployment}"
            else:
                base_url = f"{azure_endpoint}/openai_api"
        else:
...
class AsyncAzureOpenAI(BaseAzureClient[httpx.AsyncClient, AsyncStream[Any]], AsyncOpenAI):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new asynchronous azure openai_api client instance.

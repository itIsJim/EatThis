...
You tried to access openai_api.{symbol}, but this is no longer supported in openai_api>=1.0.0 - see the README at https://github.com/openai/openai-python for the API.

You can run `openai_api migrate` to automatically upgrade your codebase to use the 1.0.0 interface. 

Alternatively, you can pin your installation to the old version, e.g. `pip install openai_api==0.28`
...
# in `openai_api/__init__.py` they aren't added to the auto-complete
